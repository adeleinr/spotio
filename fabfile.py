...
def environment():
    ...
    #     whole_path looks like /web/bfun/releases/1/bfun
    #     This is where the code really is
    env.whole_path = "%s/releases/%s/%s"%(env.code_root, env.release, env.project_name)
    #     whole_path_symlinked looks like /web/bfun/releases/current/bfun
...
def upload_tar_from_git(path):
    ...
    # /web/bfun/releases/20202020202/bfun
